...
export default function AboutPage() {
  return <><PageEffects /><Header /><main id="main-content" tabIndex={-1}>
    ...
    <section className="principles-section"><div className="wrap"><div className="section-heading reveal"><span className="section-label">04 / Principles</span><h2>Four rules we keep.</h2></div><ol className="principles-list reveal"><li><span>01</span><strong>Ship real things</strong><p>Working software beats a perfect presentation.</p></li><li><span>02</span><strong>Say it straight</strong><p>Clear constraints create better decisions.</p></li><li><span>03</span><strong>Build to last</strong><p>The system should survive life after launch.</p></li><li><span>04</span><strong>Stay close</strong><p>Fewer layers, more ownership.</p></li></ol></div></section>
